...
depends(){
  apt update -y; apt upgrade wget -y; apt install wget curl gnupg lsb-release apt-transport-https ca-certificates fasttrack-archive-keyring
...
#EOF
printf "%s\n" "Types: deb" "URIs: https://deb.librewolf.net" "Suites: $distro" "Components: main" "Architectures: amd64" "Signed-By: /usr/share/keyrings/librewolf.gpg" | tee /etc/apt/sources.list.d/librewolf.sources > /dev/null
